    ...
    public partial class CustomersService
    {
        ...
        private void ValidateCustomersOnModify(Customers customers)
        {
            ...
            Validate(
                ...
                (Rule: IsNotRecent(customers.UpdatedDate), Parameter: nameof(customers.UpdatedDate)));
        }
        ...
        private static void ValidateAgainstStorageCustomersOnModify(Customers inputCustomers, Customers storageCustomers)
        {
            Validate(
                ...
                (Rule: IsNotSame(
                    firstId: inputCustomers.CreatedByUserId,
                    secondId: storageCustomers.CreatedByUserId,
                    secondIdName: nameof(Customers.CreatedByUserId)),
                Parameter: nameof(Customers.CreatedByUserId)),

                (Rule: IsSame(
                    firstDate: inputCustomers.UpdatedDate,
                    secondDate: storageCustomers.UpdatedDate,
                    secondDateName: nameof(Customers.UpdatedDate)),
                Parameter: nameof(Customers.UpdatedDate)));
        }
